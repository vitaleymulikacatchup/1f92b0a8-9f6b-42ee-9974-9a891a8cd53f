...
export const metadata: Metadata = {
  title: "Grand Vista Hotel - Luxury Accommodations & 5-Star Service",
  description: "Experience unparalleled luxury at Grand Vista Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service for unforgettable stays.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, spa resort, fine dining, luxury travel, executive suites",
  openGraph: {
    title: "Grand Vista Hotel - Luxury Accommodations & 5-Star Service",
    description: "Experience unparalleled luxury at Grand Vista Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service for unforgettable stays.",
    ...
    images: [
      {
        ...
        alt: "Grand Vista Hotel luxury lobby interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Grand Vista Hotel - Luxury Accommodations & 5-Star Service",
    description: "Experience unparalleled luxury at Grand Vista Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service.",
